...
CONFIG(debug, debug|release): {
    ...
    EXTRA_BINFILES += $$quote($$_PRO_FILE_PWD_/../lib_x64/win/Debug/$$1/debug/*.exe)
...
CONFIG(release, debug|release): {
    EXTRA_BINFILES += $$quote($$_PRO_FILE_PWD_/../lib_x64/win/Release/$$1/release/*.exe)
...
CONFIG(debug, debug|release): {
    ...
    EXTRA_BINFILES += $$quote($$_PRO_FILE_PWD_/../lib_x64/lnx/Debug/$$1/$$1)
...
CONFIG(release, debug|release): {
    EXTRA_BINFILES += $$quote($$_PRO_FILE_PWD_/../lib_x64/lnx/Release/$$1/$$1)
