...
# 包含头文件目录
include_directories(${BUILD_INCLUDE_DIR}/gaeactor-utils-location)
# 链接库目录
link_directories("${BUILD_LIB_DIR}/$<CONFIG>")
# 设置库名称
if (${CMAKE_BUILD_TYPE} STREQUAL "Debug")
######################################################
set(sdk_gaeactor_utils_location gaeactor-utils-locationd)
######################################################
else ()
######################################################
set(sdk_gaeactor_utils_location gaeactor-utils-location)
######################################################
endif ()