...
TARGET = gaeactor-environment-ex
...
HEADERS += \
    ...
    gaeactor_processor_interface_instance.h \
    gaeactor_processor_normal.h

SOURCES += \
        gaeactor_processor.cpp \
        gaeactor_processor_interface.cpp \
        gaeactor_processor_interface_instance.cpp \
        gaeactor_processor_normal.cpp

copyDynamicLibrary(gaeactor-environment-ex)
