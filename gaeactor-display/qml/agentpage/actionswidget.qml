...
Rectangle {
    ...
    {
        setValSwitch(active_ctrl, contextdata, "axnActivated")
        setValContext(script_id_ctrl, contextdata, "scriptId")
        setValContext(action_key_ctrl, contextdata, "axnKeyword")
        setValContext(action_name_ctrl, contextdata, "axnName")
        setValContext(action_name_i18n_ctrl, contextdata, "axnNameI18n")
        setValContext(action_icon_ctrl, contextdata, "axnIcon")
        setValIndex(action_script_cmbx_ctrl, contextdata, "scriptLang")
        setValContext(action_verison_ctrl, contextdata, "axnVersion")
        setValContext(action_runningplan_ctrl, contextdata, "axnRunningPlan")

        if( "axnScript" in contextdata)
        {
            var scriptcode = contextdata["axnScript"];
            var codestr="";
    ...
    function saveContext()
    {
        ...
        exportcontextdata["axnActivated"] = active_ctrl.getSwitch()
        exportcontextdata["scriptId"] = script_id_ctrl.getContext()
        exportcontextdata["axnKeyword"] = action_key_ctrl.getContext()
        exportcontextdata["axnName"] = action_name_ctrl.getContext()
        exportcontextdata["axnNameI18n"] = action_name_i18n_ctrl.getContext()
        exportcontextdata["axnIcon"] = action_icon_ctrl.getContext()
        exportcontextdata["scriptLang"] = action_script_cmbx_ctrl.getSelectIndex()
        exportcontextdata["axnVersion"] = action_verison_ctrl.getContext()
        exportcontextdata["axnRunningPlan"] = action_runningplan_ctrl.getContext()
        ...
        exportcontextdata["axnScript"] = runtimgdata
    ...
    Wgt.TextFiledcontrol
    {
        id:action_name_i18n_ctrl
        anchors.top:action_name_ctrl.bottom
        anchors.topMargin:ctrl_height/4
        width: parent.width
        height: ctrl_height
    }
    ...
    {
        id:action_icon_ctrl
        anchors.top:action_name_i18n_ctrl.bottom
        anchors.topMargin:ctrl_height/4
        width: parent.width
        height: ctrl_height
    }
    ...
    Wgt.Comboxcontrol
    {
        ...
        anchors.top:action_icon_ctrl.bottom
        anchors.topMargin:ctrl_height/4
        width: parent.width
        height: ctrl_height
    }
    ...
    Wgt.TextAreacontrol
    {
        ...
        anchors.top:action_runningplan_ctrl.bottom
        anchors.topMargin:ctrl_height/4
        width: parent.width
        height: parent.height-ctrl_height*14
    }
    ...
    Component.onCompleted: {
        ...
        action_name_ctrl.setTitle(qsTr("Name:"))
        action_name_i18n_ctrl.setTitle(qsTr("NameI18n:"))
        action_icon_ctrl.setTitle(qsTr("Icon:"))
        action_script_cmbx_ctrl.setTitle(qsTr("Type:"))
        action_verison_ctrl.setTitle(qsTr("Version:"))
        action_runningplan_ctrl.setTitle(qsTr("RunningPlan:"))
        ...
        action_name_ctrl.title_font_size=context_font_size
        action_name_i18n_ctrl.title_font_size=context_font_size
        action_icon_ctrl.title_font_size=context_font_size
        action_script_cmbx_ctrl.title_font_size=context_font_size
        action_verison_ctrl.title_font_size=context_font_size
        action_runningplan_ctrl.title_font_size=context_font_size
    ...
    Connections {
        target: action_name_ctrl.getObj()
        function onTextChanged(){
            modelWidget.updateActionName(dataType_Id, edit_id, action_name_ctrl.getContext())
        }
    }
}
