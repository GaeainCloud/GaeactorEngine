...
{        
    ...
    EmitVertex();
    gl_Position = vertex1 + projectionmatrix * vec4(vertices[7], 1.0);
    EmitVertex();        
    ...
    gl_Position = vertex1 + projectionmatrix * vec4(vertices[2], 1.0);
    EmitVertex();
    gl_Position = vertex1 + projectionmatrix * vec4(vertices[6], 1.0);
    EmitVertex();
    gl_Position = vertex1 + projectionmatrix * vec4(vertices[5], 1.0);
    EmitVertex();
    gl_Position = vertex1 + projectionmatrix * vec4(vertices[1], 1.0);
    EmitVertex();
    gl_Position = vertex1 + projectionmatrix * vec4(vertices[0], 1.0);
