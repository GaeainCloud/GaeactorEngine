...
if (MSVC)
    ...
    set(3RD_ARMADILLO_DIR "${3RD_PATH}/armadillo-12.6.2" CACHE PATH "armadillo install path")
    # 包含头文件目录
    include_directories(${3RD_ARMADILLO_DIR}/${CMAKE_BUILD_TYPE_DIR}/include)
        # 链接库目录
    link_directories("${3RD_ARMADILLO_DIR}/${CMAKE_BUILD_TYPE_DIR}/lib")
    set(libarmadillo armadillo)
endif ()