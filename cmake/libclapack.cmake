if (MSVC)
    ...
    # 设置第三方库的路径
    set(3RD_CLAPACK_DIR "${3RD_PATH}/lapack-3.12.0" CACHE PATH "clapack install path")
    link_directories("${3RD_CLAPACK_DIR}/${CMAKE_BUILD_TYPE_DIR}/lib")
    # 设置库名称
    if (${CMAKE_BUILD_TYPE} STREQUAL "Debug")
    ######################################################
    set(libclapack blasd lapackd gfortran)
    ######################################################
    else ()
    ######################################################
    set(libclapack blas lapack gfortran)
    ######################################################
    endif ()
endif ()