...
# 包含头文件目录
include_directories(${gaeactor_DIR}/gaeactor-environment-ex)
# 链接库目录
link_directories("${CMAKE_BINARY_DIR}/lib/${CMAKE_BUILD_TYPE_DIR}")
# 设置库名称
if (${CMAKE_BUILD_TYPE} STREQUAL "Debug")
######################################################
set(sdk_gaeactor_environment_ex gaeactor-environment-exd)
######################################################
else ()
######################################################
set(sdk_gaeactor_environment_ex gaeactor-environment-ex)
######################################################
endif ()