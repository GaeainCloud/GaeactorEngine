if (MSVC)
    ...
    # 设置第三方库的路径
    set(3RD_PYBIND11_DIR "${3RD_PATH}/pybind11-master" CACHE PATH "pybind11 install path")
    set(3RD_PYTHON_DIR "${3RD_PATH}/Python-3.12.2" CACHE PATH "python install path")
    # 包含头文件目录
    include_directories(${3RD_PYBIND11_DIR}/include)
    
    string(TOLOWER ${CMAKE_BUILD_TYPE} BUILD_TYPE_LOWER)
    include_directories(${3RD_PYTHON_DIR}/${BUILD_TYPE_LOWER}/include/python3.12)
    # 链接库目录
    link_directories("${3RD_PYTHON_DIR}/${BUILD_TYPE_LOWER}/lib")
    set(libpybind11 python3.12)
endif ()