add_compile_definitions (USING_COGNITIVECLUSTERSERVICE_EXPORT_LIB)
# 设置第三方库的路径
...
# 包含头文件目录
include_directories(${DynaModex_DIR}/dyniel/CognitiveClusterService)
# 链接库目录
link_directories("${CMAKE_BINARY_DIR}/lib/${CMAKE_BUILD_TYPE_DIR}")
# 设置库名称
if (${CMAKE_BUILD_TYPE} STREQUAL "Debug")
######################################################
set(sdk_cognitiveclusterservice CognitiveClusterServiced)
######################################################
else ()
######################################################
set(sdk_cognitiveclusterservice CognitiveClusterService)
######################################################
endif ()