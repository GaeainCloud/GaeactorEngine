...
# 包含头文件目录
include_directories(${DynaModex_DIR}/dyniel/demservice-standalone)
# 链接库目录
link_directories("${CMAKE_BINARY_DIR}/lib/${CMAKE_BUILD_TYPE_DIR}")
# 设置库名称
if (${CMAKE_BUILD_TYPE} STREQUAL "Debug")
######################################################
set(sdk_demservice_standalone demservice-standaloned)
######################################################
else ()
######################################################
set(sdk_demservice_standalone demservice-standalone)
######################################################
endif ()