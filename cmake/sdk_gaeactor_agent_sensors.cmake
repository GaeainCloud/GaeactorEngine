...
# 包含头文件目录
include_directories(${gaeactor_DIR}/gaeactor-agent-sensors)
# 链接库目录
link_directories("${CMAKE_BINARY_DIR}/lib/${CMAKE_BUILD_TYPE_DIR}")
# 设置库名称
if (${CMAKE_BUILD_TYPE} STREQUAL "Debug")
######################################################
set(sdk_gaeactor_agent_sensors gaeactor-agent-sensorsd)
######################################################
else ()
######################################################
set(sdk_gaeactor_agent_sensors gaeactor-agent-sensors)
######################################################
endif ()