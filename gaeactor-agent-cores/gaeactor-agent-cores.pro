...
CONFIG += c++17
TARGET = gaeactor-agent-cores

DEFINES += GAEACTOR_AGENT_CORES_LIBRARY
...
HEADERS += \
    gaeactor_agent_cores_define.h \
    gaeactor_agent_cores_global.h \
    gaeactor_agent_cores_interface.h \
    gaeactor_agent_cores_processor.h

SOURCES += \
    gaeactor_agent_cores_interface.cpp \
    gaeactor_agent_cores_processor.cpp


copyDynamicLibrary(gaeactor-agent-cores)
