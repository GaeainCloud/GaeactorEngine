...
QNetworkAccessManager* networkManager2 = nullptr;
}
...
bool GeoPos::operator ==(const GeoPos &other) const
{
    if(this == &other)
        return true;
    return (fabs(mLat - other.mLat)<0.00001f & fabs(mLon - other.mLon)<0.00001f);
}
...
void setNetworkManager2(QNetworkAccessManager* manager)
{
    networkManager2 = manager;
}

QNetworkAccessManager* getNetworkManager2()
{
