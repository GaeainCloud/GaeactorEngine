...
QString QGVLayerGoogle::getMapDirDesc()
{
    const QMap<QGV::TilesType, QString> adapter = {
                                                   { QGV::TilesType::Satellite, "Satellite" },
                                                   { QGV::TilesType::Schema, "Schema" },
                                                   { QGV::TilesType::Hybrid, "Hybrid" },
                                                   };

    QString mapdesc = QString("/Google/%1").arg(adapter[mType]);
    return mapdesc;
}
