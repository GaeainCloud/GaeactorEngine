...
Q_SIGNALS:
    ...
    void mapMouseRelease(QPointF projPos);
    void mapMouseDoubleClick(QPointF projPos);

    void mapwheelEvent(QWheelEvent *event);

    void mapKeyPressEvent(QKeyEvent *event);
    void mapKeyReleaseEvent(QKeyEvent *event);
